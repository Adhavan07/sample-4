    ...
    $(document).ready(function() {
        ...
        if ($('.main-slider-active').length) {
            $('.main-slider-active').slick({
                ...
                infinite: true,
                speed: 1000,
                arrows: false, // Set to true to show arrows for manual navigation
                dots: true,
                fade: true,
                focusOnSelect: true,
            ...
            if ($.fn.circleProgress) {
                progress.appear(function() {
                    progress.circleProgress({
                        ...
                        $(this).find('.counting').html(Math.round(90 * progress) + '<span>%</span>');
                    });
                });
            };
        };
...
form.addEventListener('submit', function(event) {
    ...
    // Send the form data to form-process.php using AJAX
    fetch('form-process.php', {
        ...
        .then(data => {
            showPopup(data); // Show the response message in the popup
        })
        .catch(error => {
...
// Close the popup when the user clicks anywhere outside the modal
